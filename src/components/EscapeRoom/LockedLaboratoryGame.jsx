        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="flex gap-3">
              <button
                onClick={checkAnswer}
                className="flex-1 bg-blue-500 hover:bg-blue-600 text-white cursor-pointer font-semibold py-3 px-6 rounded-lg flex items-center justify-center transition-all transform hover:scale-105"
              >
