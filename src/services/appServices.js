...
export const fetchQuestionsByFinishCategory = async (category, subcategory) => {
  try {
    // console.log(`Fetching questions for category: ${category}`);
    const response = await fetch(`http://localhost:8080/quiz-type/${category}/${subcategory}`);
...
export const setSignupInfo = async (signupData) => {
  try {
    const response = await fetch('http://localhost:8080/signup-submit', {
      method: 'POST',
      headers: {
...
export const setLogoutInfo = async () => {
  try {
    const response = await fetch('http://localhost:8080/logout-submit', {
      method: 'POST',
      credentials: 'include', 
    });
...
export const fetchPlayCount = async(category) => {
  try {
    const response = await fetch(`http://localhost:8080/api/playcount/${category}`, {method : "GET"});
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setPlayCount = async (category) => {
  try {
    const response = await fetch(`http://localhost:8080/api/playcount/${category}`, { method: "PUT" });
...
export const fetchCompleteStatus = async(category) => {
  try {
    const response = await fetch(`http://localhost:8080/api/completestatus/${category}`, {method : "GET"});
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setCompleteStatus = async (category) => {
  try {
    const response = await fetch(`http://localhost:8080/api/completestatus/${category}`, { method: "PUT" });
...
export const fetchCStatus = async(category, userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/cstatus/${category}/${userId}`, {method : "GET"});
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setCStatus = async (category, userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/cstatus/${category}/${userId}`, { method: "PUT" });
...
export const fetchQuizPlayed = async(id) => {
  try {
    const response = await fetch(`http://localhost:8080/api/quizplayed/${id}`, {method : "GET"});
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setQuizPlayed = async (id) => {
  try {
    const response = await fetch(`http://localhost:8080/api/quizplayed/${id}`, { method: "PUT" });
...
export const fetchBadgesByUser = async(userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/userbadges/${userId}`, {method : "GET"});
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setFirstQuizBadge = async (userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/badges/${userId}/firstcategoryquiz`, { method: "PUT", credentials: 'include' });
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
  } catch (error) {
...
export const setSecondCategoryQuizBadge = async (userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/badges/${userId}/secondcategoryquiz`, { method: "PUT", credentials: 'include' });
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    return; 
...
export const updateSecondCategoryQuizBadge = async (userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/badges/${userId}/secondcategoryquizprogress`, { method: "PUT", credentials: 'include' });
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    return; 
...
export const fetchCategoryQuizPlayed = async(userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/categoryquizplayed/${userId}`, {method : "GET"}); 
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    const data = await response.json();
...
export const setCategoryQuizPlayed = async (userId) => {
  try {
    const response = await fetch(`http://localhost:8080/api/categoryquizplayed/${userId}`, { method: "PUT" }); 
    if (!response.ok) {
      throw new Error('Network response was not ok');
    }
    return; 
